...
1. Top Hat Data obtained from the Department of Labor
2. That data, supplemented with links to additional sources of specific employer information - specifically, Paycheck Protection Program data and WARN alerts
