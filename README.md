...
<p>1. Top Hat Data obtained via FOIA request from the U.S. Department of Labor</p>
<p>2. That data, supplemented with links to additional sources of specific employer information - specifically, Paycheck Protection Program data and WARN alerts</p>
